...
\newif\ifdraftnotes
\draftnotesfalse         % <<< \draftnotesfalse for the submitted PDF
...
\midrule
Nested $>$ Hybrid (wtd)   & 0.0035 & 0.0007 & 4/4 \\
Hybrid (wtd) $>$ SVD      & 0.0103 & 0.0019 & 4/4 \\
Nested $>$ Most-Popular   & 0.0150 & 0.0066 & 4/4 \\
Most-Popular $>$ AutoRec  & 0.0073 & 0.0043 & 4/4 \\
SVD $>$ Hybrid (switch)   & 0.0025 & 0.0005 & 4/4 \\
SVD vs.\ Most-Popular     & 0.0012 & 0.0052 & \textbf{sign flips} \\
\bottomrule
\end{tabular}
...
cancels that shared movement. Table~\ref{tab:robust} reports the result.
...
on every split by $+0.0103 \pm 0.0019$. The beyond-accuracy findings are
...
$0.0025 \pm 0.0005$ across four splits, while reaching 60 cold-start slots
